...
export default class PoseHandler {
  constructor(webcamElem, cnvPoseElem) {
    ...
    this.lines = {
      0: [
        [0, 1],  // Neck to left eye
        [0, 2],  // Neck to right eye
      ],
      1: [[1, 3]],  // Left eye to left ear
      2: [[2, 4]],  // Right eye to right ear
      3: [],  // Left ear
      4: [],  // Right ear
      5: [
      ...
      7: [[7, 9]],  // Left elbow to left hand
      8: [[8, 10]], // Right elbow to right hand
      9: [],  // Left hand
      10: [], // Right hand
      11: [
      ...
      12: [[12, 14]], // Right hip to right knee
      13: [[13, 15]], // Left knee to left foot
      14: [[14, 16]], // Right knee to right foot
      15: [],  // Left foot
      16: [],  // Right foot
    };    
    // Counter handler
